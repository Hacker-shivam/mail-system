...
<body style="word-spacing:normal;background-color:#f8fafc">
    ...
    class="body-wrapper disable-heading-font-weight" style="background-color:#f8fafc">
        ...
        <div style="background:#fff;background-color:#fff;margin:0 auto;border-radius:0;max-width:600px">
                ...
                <tbody>
                    <tr>
                        <td style="border:0 solid transparent;direction:ltr;font-size:0;padding:0;padding-bottom:0;padding-left:0;padding-right:0;padding-top:0;text-align:center">
                            <!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="bl-typography-block-wrapper-outlook -outlook bg-blocku4q3y1-outlook" width="600px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="bl-typography-block-wrapper-outlook -outlook bg-blocku4q3y1-outlook" role="presentation" style="width:600px;" width="600" bgcolor="transparent" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                            <div class="bl-typography-block-wrapper bg-blocku4q3y1" style="background:0 0;background-color:transparent;margin:0 auto;border-radius:0;max-width:600px">
                                                            ...
                                                            <tr>
                                                                <td style="background-color:transparent;border:0 solid transparent;border-radius:0;vertical-align:top;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center" class="html-custom-block-img" style="font-size:0;padding:10px 25px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0;word-break:break-word">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td style="width:600px" class="mj-full-width-mobile">
                                                                                                    ...
                                                                                                    target="_blank" data-url-id="b60acc15-b246-5f88-b38f-c7ece71b9896"><img alt="Image" src="https://img.mmdocdn.com/mailmodo/image/upload/ar_946:1600,c_crop/v1756704504/editor/p/62dc8626-eafe-4c68-a935-861517fb9628/b20f300699305eadf65f9988cb020bb2_cd9fdw.jpg"
                                                                                                        style="border:0 solid transparent;border-radius:0;display:block;outline:0;text-decoration:none;height:auto;width:600px;max-width:100%;font-size:13px"
                            ...
                            <!--[if mso | IE]></td></tr></table></td></tr><tr><td class="bl-typography-block-wrapper-outlook -outlook bg-formf3fa44-outlook" width=3D"600px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="bl-typography-block-wrapper-outlook -outlook bg-formf3fa44-outlook" role="presentation" style="width:600px;" width="600" bgcolor="#00000000" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                            <div class="bl-typography-block-wrapper bg-formf3fa44" style="background:#00000000;background-color:#00000000;margin:0 auto;border-radius:0;max-width:600px">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#00000000;background-color:#00000000;width:100%;border-radius:0">
                                    <tbody>
                                        <tr>
                                            <td style="border:0 solid transparent;direction:ltr;font-size:0;padding:20px 0;padding-bottom:20px;padding-left:8px;padding-right:8px;padding-top:0;text-align:center">
                                                            ...
                                                            <tr>
                                                                <td align="center" class="amp-btn-wrapper" style="font-size:0;padding:0 0 12px 0;word-break:break-word">
                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:auto;line-height:100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center" bgcolor="#178218" role="presentation" style="border-bottom:none;border-left:none;border-radius:600px;border-right:none;border-top:none;border:0 solid transparent;cursor:auto;font-style:normal;height:auto;background:#178218;padding:0"><a href="${baseUrl}/track/form/${trackingId}?campaignName=${encodeURIComponent(campaignName)}&campaignType=${encodeURIComponent(campaignType)}"
                            ...
                            <!--[if mso | IE]></td></tr></table></td></tr><tr><td class="bl-typography-block-wrapper-outlook -outlook bg-blockp7d3x304-outlook" width="600px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="bl-typography-block-wrapper-outlook -outlook bg-blockp7d3x304-outlook" role="presentation" style="width:600px;" width="600" bgcolor="transparent" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
                            <div class="bl-typography-block-wrapper bg-blockp7d3x304" style="background:0 0;background-color:transparent;margin:0 auto;border-radius:0;max-width:600px">
                                <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:0 0;background-color:transparent;width:100%;border-radius:0">
                                    <tbody>
                                        <tr>
        ...
        width="1" height="1" alt="signature" src="https://tn.btrkr.com/opens/html/a6548890-d0d2-5a83-9922-c092e3102374/5a1d504a-f747-449c-b739-021eca44c63b">
            <table width="100%" align="center" style="margin-top: 12px;">
                <tbody>
                    <tr>
                        <td width="100%" align="center"> <a style="margin-left: auto; margin-right: auto; color: grey; font-size: 12px; text-decoration: underline;" href="${baseUrl}/unsubscribe/${trackingId}">Unsubscribe</a>                            </td>
                    </tr>
                </tbody>
