                                                            ...
                                                            <tr>
                                                                <td align="center" class="amp-btn-wrapper" style="font-size:0;padding:0 0 12px 0;word-break:break-word">
                                                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:auto;line-height:100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td align="center" bgcolor="#178218" role="presentation" style="border-bottom:none;border-left:none;border-radius:600px;border-right:none;border-top:none;border:0 solid transparent;cursor:auto;font-style:normal;height:auto;background:#178218;padding:0"><a href="${baseUrl}/track/form/${trackingId}"
